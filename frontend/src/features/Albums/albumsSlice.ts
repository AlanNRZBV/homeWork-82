...
export const isAlbumLoading = (state: RootState) =>
  state.albums.isSingleAlbumLoading;
export const isAlbumSubmitting = (state: RootState) =>
  state.albums.isSingleAlbumSubmitting;
